...
1. Install node 18.18.0 and npm 10.2.4
2. Clone the repo in your local directory
```sh
    git clone https://github.com/code-123-sudo/Round1Assignment.git
```
3. Run Below command
```sh
   npm install
...
<!-- USAGE EXAMPLES -->
## Usage
1. Users can create a new note by clicking on + button.
2. All notes are be draggable to any position on the
   board.
...
5. Users are able to pin notes by clicking on "PIN" button, which will make
   ...
   overlapping with them.Users can unpin any pinned note.If pinned, "PIN" button changes to "UNPIN" and 
   if unpinned, "UNPIN" button changes to "PIN"
...
Project Link: [https://github.com/code-123-sudo/Round1Assignment](https://github.com/code-123-sudo/Round1Assignment)
